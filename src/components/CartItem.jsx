...
function CartItem({ id, name, imageUrl, price, sizeForCart, typeForCart }) {
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-price">
                <b>{price}<svg className="ruble-svg"><use xlinkHref="#ruble" /></svg></b>
            </div>
            <div className="cart__item-remove">
                <button onClick={() => onRemovePizzaFromCart({ id, price, sizeForCart, typeForCart })} className="button button--outline button--circle">
