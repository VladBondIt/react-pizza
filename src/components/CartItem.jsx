...
function CartItem({ id, name, imageUrl, calcedPrice, sizeForCart, typeForCart }) {
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-remove">
                <button onClick={() => onRemovePizzaFromCart({ id })} className="button button--outline button--circle">
